        ...
        <Reveal>
          ...
          <div className="mt-10">
            <a
              ...
              className="inline-flex items-center justify-center rounded-full bg-[color:var(--ink)] text-[color:var(--cream)] px-9 py-5 text-sm tracking-[0.16em] uppercase hover:bg-[color:var(--brown)] transition-colors shadow-warm"
            >
              {WHATSAPP_CTA}
            </a>
          </div>
